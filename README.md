...
| 자동 테스트 | 69개 PASS | `make verify PYTHON=python3.8` |
| Python 3.8·3.14 실행 | 각각 69개 PASS | 공식 Python 컨테이너 |
...
구문 컴파일, 과제에 적용한 PEP 8·257 핵심 규칙, unittest 69개, 합성 데이터
...
로컬에서는 공식 `python:3.8-slim`과 `python:3.14-slim`에서 같은 69개
